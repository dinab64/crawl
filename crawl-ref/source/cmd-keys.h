...
{'\r', CMD_TARGET_SELECT},
{'5', CMD_TARGET_SELECT},
{-1019, CMD_TARGET_SELECT_ENDPOINT}, // numpad .
...
//{'f', CMD_TARGET_SELECT}, // HACK: Moved to be the downmost for tutorial key
                            // look-up.
{'g', CMD_TARGET_GET},
{-1018, CMD_TARGET_CYCLE_BACK}, // numpad -
{-1020, CMD_TARGET_CYCLE_BACK}, // numpad -, maybe?
{'-', CMD_TARGET_CYCLE_BACK},
{'=', CMD_TARGET_CYCLE_FORWARD},
{-1016, CMD_TARGET_CYCLE_FORWARD}, // numpad +
{-1017, CMD_TARGET_CYCLE_FORWARD}, // numpad +, maybe?
{'+', CMD_TARGET_CYCLE_FORWARD},
{-1012, CMD_TARGET_OBJ_CYCLE_BACK}, // numpad /, sometimes
{'/', CMD_TARGET_OBJ_CYCLE_BACK},
{';', CMD_TARGET_OBJ_CYCLE_BACK},
{-1015, CMD_TARGET_OBJ_CYCLE_FORWARD}, // numpad *, sometimes
...
{-1016, CMD_MAP_SCROLL_DOWN}, // numpad +
{-1017, CMD_MAP_SCROLL_DOWN}, // numpad +, maybe
{'+', CMD_MAP_SCROLL_DOWN},
{CK_MOUSE_B5, CMD_MAP_SCROLL_DOWN},
{-1018, CMD_MAP_SCROLL_UP},
{'-', CMD_MAP_SCROLL_UP},
...
{'\'', CMD_MAP_FIND_STASH},
{-1019, CMD_MAP_GOTO_TARGET}, // numpad .
{'.', CMD_MAP_GOTO_TARGET},
